...
class ReportGenerator:
    ...
    def generate_markdown_report(self, categorized_changes: Dict[str, List[Dict]], 
        ...
        if categorized_changes['merged']:
            report.append(f"\n## ✅ Merged Changes ({len(categorized_changes['merged'])})\n")
        ...
        if categorized_changes['open']:
            report.append(f"\n## 🔍 Open Changes Awaiting Review ({len(categorized_changes['open'])})\n")
        ...
        if categorized_changes['abandoned']:
            report.append(f"\n## ❌ Abandoned Changes ({len(categorized_changes['abandoned'])})\n")
